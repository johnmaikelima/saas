        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form method="POST">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4"><label class="form-label">Nome da Loja</label><input type="text" class="form-control" name="nome_loja" value="<?= e(getConfig('nome_loja', $empresa['nome_fantasia'] ?? 'PDV Pro')) ?>"></div>
