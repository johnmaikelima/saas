...
<head>
    ...
    <meta name="description" content="Emissor NFC-e grátis para seu negócio. Baixe o PDV Pro e emita até 30 notas fiscais por mês sem pagar nada. Sistema completo com PDV, estoque e relatórios.">
    ...
    <title>Emissor NFC-e Grátis - PDV Pro | Sistema de Vendas Completo</title>
...
<nav class="navbar-landing">
    <div class="container d-flex justify-content-between align-items-center">
        <a class="navbar-brand-custom" href="/"><i class="fas fa-cash-register"></i> PDV Pro</a>
...
<section class="section-white">
    <div class="container">
        <div class="text-center mb-5">
            ...
            <p class="section-subtitle animate-on-scroll">O PDV Pro oferece um sistema completo de vendas, não apenas um emissor de notas fiscais.</p>
        </div>
        <div class="row g-4">
...
<section id="precos" class="section-gray">
    <div class="container">
        ...
        <div class="text-center mt-4">
            <p class="text-muted">
                <i class="fas fa-cloud me-1"></i>Prefere acessar de qualquer lugar? Conheça a <a href="/" style="color:var(--primary);font-weight:600;">versão online (SaaS)</a> do PDV Pro.
            </p>
        </div>
    </div>
</section>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <div class="faq-item animate-on-scroll">
                    ...
                    <div class="faq-answer"><p>O PDV Pro Desktop funciona em Windows 10 ou superior. Se você prefere acessar pelo navegador (sem instalar), conheça nossa versão online (SaaS) que funciona em qualquer dispositivo.</p></div>
                </div>
                <div class="faq-item animate-on-scroll">
...
<section class="cta-section" style="padding: 5rem 0;">
    <div class="container text-center">
        ...
        <a href="#" class="btn-cta animate-on-scroll"><i class="fas fa-download"></i> Baixar PDV Pro Grátis</a>
    </div>
</section>
...
<footer class="footer">
    <div class="container">
        <div class="row g-4">
            <div class="col-md-4">
                <div class="footer-brand"><i class="fas fa-cash-register"></i> PDV Pro</div>
        ...
        <div class="footer-bottom">
            <p>&copy; <?= date('Y') ?> PDV Pro. Todos os direitos reservados.</p>
        </div>
    </div>
</footer>
